...
export const DocumentsDashboard: React.FC<{ studentId?: string }> = ({ studentId }) => {
  const [documents, setDocuments] = useState<DocumentFile[]>([
    { id: '1', name: 'Chopin_Nocturne_Op9_No2.pdf', type: 'sheet_music', uploadDate: '2024-11-10', size: '2.4 MB', studentId: '1' },
    { id: '2', name: 'Finger_Exercises.pdf', type: 'reference', uploadDate: '2024-11-08', size: '1.8 MB', studentId: '2' },
  ...
  const visibleDocuments = documents.filter(d => !studentId || d.studentId === studentId);
